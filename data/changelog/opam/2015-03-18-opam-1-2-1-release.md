...
[OPAM 1.2.1](https://github.com/ocaml/opam/releases/tag/1.2.1 - [429 Too Many Requests]) has just been
...
See [the changelog](https://github.com/ocaml/opam/blob/1.2.1/CHANGES - [429 Too Many Requests]) for a
summary or
...
[official repository](https://github.com/ocaml/opam-repository - [429 Too Many Requests]) until the next
release.
...
* New field `features:` in opam files, to help with `./configure` scripts and
  ...
  [original proposal](https://github.com/ocaml/opam/blob/master/doc/design/depopts-and-features - [429 Too Many Requests])
