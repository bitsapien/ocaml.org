...
changelog](https://github.com/ocaml/opam/blob/2.1.0-alpha/CHANGES - [429 Too Many Requests]) or [release
note](https://github.com/ocaml/opam/releases/tag/2.1.0-alpha - [429 Too Many Requests]) for the details),
...
1. Either from binaries: run
    ...
    or download manually from [the Github "Releases" page](https://github.com/ocaml/opam/releases/tag/2.1.0-alpha - [429 Too Many Requests]) to your PATH.

2. Or from source, manually: see the instructions in the [README](https://github.com/ocaml/opam/tree/2.1.0-alpha#compiling-this-repo - [429 Too Many Requests]).
